...
<table class="table table-info"  border="2"><!-- class="table table-striped" -->
  <thead>
    <tr>
    <th scope="col">Id</th> 
    ...
    <tbody>
    	...
    	<td><a href="edit?id=<c:out value="${i.id}"></c:out>">Edit</a> &nbsp; &nbsp; <a href="delete?id=<c:out value="${i.id}"></c:out>">Delete</a></td>
    	</tr>
    	</c:forEach>
